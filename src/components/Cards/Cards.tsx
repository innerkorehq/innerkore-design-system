...
export const MyCard: FC<MyCardType> = ({ MyCardItems,
}) => {
  return (
    <div className="bg-gray-200 px-5 md:px-20 xl:px-30 py-10 lg:py-32">
      <Row gutter={[32, 32]}>
        {MyCardItems.map(({titleHref, titleTxt, paraTxt, link1Href, link1Txt, link2Href, link2Txt, iconImgSrc, cardImgSrc, cardImgAlt }) => {
          return (
            <Col md={12} xl={8}>
              <Card
                hoverable
